...
// const getMarsTemperature = () => {
//   const maxTemperature = 58;
//   const sucssesRate = Math.random();
//   if (sucssesRate < 0.6) return false;
//   return Math.floor(Math.random() * maxTemperature);
// }
...
//     setTimeout(() => { getMarsTemperature() ? callback1(getMarsTemperature()) : callback2('Robot is busy') }, messageDelay())
// }
